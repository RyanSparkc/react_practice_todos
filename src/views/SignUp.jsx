        ...
        <div className="conatiner signUpPage vhContainer">
            ...
            <div>
                <form className="formControls" action="index.html">
                    ...
                    <input className="formControls_input" type="text" id="email" name="email" placeholder="請輸入 email" required></input>
                    <label className="formControls_label" htmlFor="name">您的暱稱</label>
                    <input className="formControls_input" type="text" name="name" id="name" placeholder="請輸入您的暱稱"></input>
                    <label className="formControls_label" htmlFor="pwd">密碼</label>
                    <input className="formControls_input" type="password" name="pwd" id="pwd" placeholder="請輸入密碼" required></input>
                    ...
                    <input className="formControls_btnSubmit" type="button" onClick={() => {
